...
Here I run with $K=9$ and point-exponential. It finds a rank 3 solution, zeroing out the other 6. This is definitely missing some structure, showing the need for more careful initialization. 
...
Here we try initializing GB with point-exponential. It produces a fit with the intermediate components.
```{r}
set.seed(2)
fit = random_init(S,9)
