...
It is interesting that glmnet and genlasso give quite different answers. Also it looks
like in this case `mr.ash` is converging to local optima. (the change is a bit too early...)
