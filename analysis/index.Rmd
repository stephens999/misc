...
* [Burer-Monteiro approach to binary quadratic optimization](burer_monteiro.html)
* [Comparing fastICA and alternating projection for binary group recovery](compare_fastica_altproj.html)

# ICA

* [Initial try of fastICA on simulated data](fastica_01.html)
* [Single unit fastICA on simulated data](fastica_02.html)
* [Single unit fastICA with centering, to help find asymmetric binary groups (flawed)](fastica_centered.html)
* [Single unit fastICA with intercept, to help find asymmetric binary groups](fastica_centered_02.html)
* [FastICA with tilted log-cosh contrast for skewed/sparse binary sources](fastica_skew.html)
* [FastICA for non-whitened data: exact equivariance and initialization bias](fastica_nonwhitened.html)
* [Preconditioned FastICA: homotopy method and TLC contrast](fastica_precondition.html)
* [EB FastICA with asymmetric prior: alternating optimization for sparse sources](fastICA_asymmetric.html)
* [EBproj: quasi-Newton with binary prior and Section-5 sigma (Test 1)](ebproj_newton.html)
* [EBproj with a point-exponential prior: parallel Newton updates for w](fastica_asymmetric_05.html)
* [fastICA with x|x| contrast on 1000 Genomes data](fastica_1kg.html)
* [Optimizing the x|x| contrast on unwhitened data: a quasi-Newton family](fastica_unwhitened_optim.html)
* [Unwhitened fastICA (x|x| contrast) on 1000 Genomes data](fastica_1kg_unwhitened.html)
* [Structure plots from fastICA sources on 1000 Genomes data](fastica_1kg_structure.html)
* [fastICA with x|x| contrast on HGDP haplotypes](fastica_hgdp.html)

* [Motivated by ICA, I try a flash+low-rank approach](flash_pca.html)
* [Motivated by ICA, I try an EB approach to find subspaces](EB_subspace.html)
